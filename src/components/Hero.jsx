      ...
      >
        ...
        <div>
          ...
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
            Experienced Full Stack Engineer with 6+ years in Frontend and Backend Development for Web Apps and Smart Contracts on Blockchains. <br className="sm:block hidden" />
            <p>
